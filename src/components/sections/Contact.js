...
import { FiMail, FiSend, FiCheck, FiAlertCircle, FiPhone, FiMapPin } from 'react-icons/fi';
                ...
                <Grid>
                    <Left>
                        ...
                        <Direct>
                            ...
                            <DirectItem href="tel:+5511971815551">
                                <FiPhone size={18} /> +55 (11) 97181-5551
                            </DirectItem>
                            <DirectItem as="span">
                                <FiMapPin size={18} /> Santo André, SP
                            </DirectItem>
                            <DirectItem href="https://github.com/lefurtado" target="_blank" rel="noreferrer">
                                <FaGithub size={18} /> github.com/lefurtado
                            </DirectItem>
                            <DirectItem href="https://www.linkedin.com/in/le-furtado/" target="_blank" rel="noreferrer">
                    ...
                    <Form onSubmit={onSubmit}>
                        ...
                        <Button $variant="gradient" type="submit" disabled={state === 'loading'}>
